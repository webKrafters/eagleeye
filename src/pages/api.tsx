...
function BodyCurrent(){
    return (
        <>
            ...
            <div id="connect">
                <h3>connect</h3>
                <ListItem><div>is a function property of the <Name />, accepting an optional <Anchor to="/concepts/selector-map">selector map</Anchor> parameter; and returning a reusable connector function.</div></ListItem>
...
function BodyPre_7_0_0(){
    return (
        <>
            <div id="connect">
                <h3>connect</h3>
                <ListItem><div>is a function taking an <Name /> instance and an optional <Anchor to="/concepts/selector-map">selector map</Anchor> parameters; and returning a reusable connector function.</div></ListItem>
                <ListItem><div>The connector function takes a client as a parameter and returns an HOC.</div></ListItem>
            ...
            <div id="create-context">
                <h3>createContext</h3>
                <ListItem><div>is a zero-parameter function returning an <Name /> instance.</div></ListItem>
                <ListItem><div>The returned object is the store-bearing context.</div></ListItem>
            ...
            <div id="usecontext">
                <h3>useContext</h3>
                <ListItem><div>is a hook taking an <Name /> instance and an optional <Anchor to="/concepts/selector-map">selector map</Anchor> parameters; and returning the context <Anchor to="/concepts/store">store</Anchor>.</div></ListItem>
                <ListItem><div>The injected <Anchor to="/concepts/store">store</Anchor> monitors changes in the underlying state slices referenced by the selector map.</div></ListItem>
                <ListItem><div>A change in any of the referenced state slices automatically triggers an update of the related <code>store.data</code> property and a subsequent render of the client.</div></ListItem>
